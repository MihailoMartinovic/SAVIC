...
If the state of VDF is sufficiently different from Local Thermodynamic Equilibrium (LTE), then the particle energy can be emitted through fields---waves are excited and particles lose energy, thereby getting ``pushed'' toward LTE :cite:p:`Stix_1992'. 
...
The calculations of traditional solvers :cite:p:`Roennmark_1982,Quataert_1998,Klein_2015_PhPl,Verscharen_2018_ArXiv_NHDS' can be done up to an arbitrary level of precision, but generally require a large volume of CPU hours, making them less convenient for analysis of larger data sets. 
